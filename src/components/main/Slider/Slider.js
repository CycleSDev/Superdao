...
export const Slider = () => {
  ...
  useEffect(() => {
    document
      .getElementsByClassName("Slider__content-Menu")[0]
      .addEventListener("click", (e) => {
        document
          .getElementsByClassName("Slider-Menu-Selected")[0]
          .classList.remove("Slider-Menu-Selected");
    ...
    <div className="Slider">
      ...
      <div className="Slider__content">
        <div className="Slider__content-Menu">
          <p className="Slider-Menu-Selected" data="1">
            NFT membership
          </p>
